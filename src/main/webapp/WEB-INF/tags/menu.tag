...
<li role="presentation"><a role="menuitem" tabindex="-1" href="${contextPath}/ws/dashboard">Home</a></li>
<li role="presentation"><a role="menuitem" tabindex="-1" href="${contextPath}/ws/ash">ASH</a></li>
