...
from DBA_EXTENTS ex inner join ALL_TABLES t on ex.segment_name = t.table_name and ex.owner = t.owner
...
from DBA_EXTENTS ex inner join ALL_INDEXES i on ex.segment_name = i.index_name and ex.owner = i.owner
...
from DBA_EXTENTS ex inner join ALL_LOBS l on ex.segment_name = l.segment_name and ex.owner = l.owner
...
from DBA_EXTENTS ex inner join ALL_LOBS l on ex.segment_name = l.index_name and ex.owner = l.owner
